...
CREATE TABLE attendance_devices_new (
    ...
    status TEXT NOT NULL DEFAULT 'offline' CHECK (status IN ('online', 'offline', 'deactivated')),
    created_at TEXT DEFAULT (datetime('now')),
    updated_at TEXT DEFAULT (datetime('now'))
);

INSERT INTO attendance_devices_new (
    id,
    uid,
    ip,
    port,
...
ALTER TABLE attendance_devices_new RENAME TO attendance_devices;

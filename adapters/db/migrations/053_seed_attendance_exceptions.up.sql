-- Seed derived attendance exceptions for the sample attendance data.
-- These rows mirror the current calculation rules so the seeded database
-- shows exceptions immediately when browsing attendance logs or the table.

CREATE TABLE attendance_reminders_old (
...
INSERT INTO attendance_reminders_old (
    id, uid, employee_uid, attendance_date, reminder_type, sent_at, created_at, updated_at
)
SELECT
    id, uid, employee_uid, attendance_date, reminder_type, sent_at, created_at, updated_at
FROM attendance_reminders
WHERE reminder_type = 'missing_check_out';

DROP TABLE attendance_reminders;

ALTER TABLE attendance_reminders_old RENAME TO attendance_reminders;

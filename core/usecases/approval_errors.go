...
var (
	...
	ErrRequestNotRejected      = errors.New("request is not rejected")
	ErrApprovalFlowMismatch    = errors.New("leave type approval flow does not match existing approval request")
)
